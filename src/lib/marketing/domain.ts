...
export const draftSchema = z.object({
 ...
 startDate: date, endDate: date, stayStartDate:date.optional(),stayEndDate:date.optional(), mediaBudgetMinor: minorAmount, dailyBudgetMinor: minorAmount.optional(),
...
export interface ListingEvidence {id:number;hostId:number;title:string;description:string;slug:string;city:string;publicationStatus:string;currency:string;price:string;media:{id:string;url:string;type:'IMAGE'|'VIDEO';approved:boolean}[];campaignCreative?:CampaignCreativeEvidence;}
