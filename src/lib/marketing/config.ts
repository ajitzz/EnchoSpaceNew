...
export function readMarketingConfig(raw=process.env.HARVO_MARKETING_CONFIG):MarketingRuntimeConfig{
 if(!raw)return {origin:process.env.GOOGLE_ADS_LANDING_ORIGIN||'',mediaOrigins:[],currency:'INR',markupBps:500,financialPolicy:null,policyAdminId:null,costRules:[],remittanceTax:{base:'NONE',rateBps:0},fundingEnabled:false,publishingEnabled:false,activationEnabled:false,providerClearance:{},checkoutAcceptanceReference:null,meta:{countries:[],placements:[],specialAdCategories:[]}};
