...
<svg viewBox="0 0 260 40" xmlns="http://www.w3.org/2000/svg">
  ...
  <!-- ve and leaf -->
  <path d="M 185 14 H 192 L 197 29 L 202 14 H 209 L 201 34 H 193 Z" fill="#10B981" />
  <path d="M 225 14 C 235 14 240 19 240 25 H 216 C 217 30 221 34 226 34 C 230 34 233 32 235 29 L 241 32 C 238 36 232 37 226 37 C 215 37 208 30 208 24 C 208 18 215 14 225 14 Z M 225 19 C 220 19 217 21 216 24 H 233 C 232 21 229 19 225 19 Z" fill="#10B981" />
  <path d="M 233 16 C 236 6 246 2 249 4 C 250 10 243 15 233 16 Z" fill="#10B981" />
</svg>
`;

fs.writeFileSync('test_amigo2.svg', svg);
