...
async function main() {
  try {
    ...
    `, ['Test title', 'Test desc', 'Dest', 'Dep', '2025-01-01', '2025-01-02', 999, 10, 10, JSON.stringify([]), ['WiFi', 'Food'], ['http://image.com'], 1, 'upcoming', 'all', JSON.stringify([]), null, JSON.stringify([]), JSON.stringify([]), null, ['http://video.com'], ['Travel'], null, null, 'English', null, null]);
