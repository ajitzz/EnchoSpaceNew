...
const startIndex = file.indexOf('<div className="flex items-center gap-4">');
// Find where to resume
const endIndex = file.indexOf('<div className="space-y-2">', startIndex + 1);
...
file = file.substring(0, startIndex) + replacement + file.substring(endIndex + '<div className="space-y-2">'.length);
