...
export const InboxSkeleton = () => (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 h-[calc(100vh-80px)]">
        ...
        <div className="bg-white border border-gray-200 rounded-3xl overflow-hidden shadow-sm h-[calc(100%-80px)] flex">
...
export const AdminInboxSkeleton = () => (
    <div className="bg-white rounded-2xl shadow-sm border border-gray-200 h-[600px] flex overflow-hidden">
        <div className="w-full md:w-1/3 border-r border-gray-200 flex flex-col bg-slate-50/50">
            <div className="p-4 border-b border-gray-100 bg-white/50 backdrop-blur-md sticky top-0 z-10 space-y-2">
            ...
            <div className="flex-1 p-2 space-y-2">
                {[1,2,3,4].map(n => (
                    <div key={n} className="p-3 rounded-2xl flex gap-3 items-center relative overflow-hidden border border-gray-100 bg-white">
