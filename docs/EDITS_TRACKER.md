...
## 15. Calendar / Marketing Pipeline: The Double-Blind Schema Deadlock Fix
**Files Modified:** `server.ts`
**Target:** Live Neon Postgres Database (`marketing_campaign_workflows`, `marketing_jobs`)
**Description:**
The Marketing Engine activation was permanently blocked by the Calendar asserting "0 Physical Units Live". This was diagnosed as a catastrophic double-blind failure.
